...
#include "ui_simulateduiwidgetMambo.h"

// NOTE: RadioUiAction(NUMBER,...): NUMBER relates to enum EnumKeys in the specific board.h

SimulatedUIWidgetMambo::SimulatedUIWidgetMambo(SimulatorInterface *simulator, QWidget * parent):
  SimulatedUIWidget(simulator, parent),
  ui(new Ui::SimulatedUIWidgetMambo)
{
  RadioUiAction * act;
  QPolygon polygon;
  ...
  addRadioWidget(ui->leftbuttons->addArea(QRect(94, 64, 63, 30), "MAMBO/left_menu.png", act));

  act = new RadioUiAction(3, QList<int>() << Qt::Key_PageDown << Qt::Key_Down, SIMU_STR_HLP_KEYS_GO_DN, SIMU_STR_HLP_ACT_PAGE);
  addRadioWidget(ui->leftbuttons->addArea(QRect(84, 22, 80, 30), "MAMBO/left_page.png", act));
  ...
  addRadioWidget(ui->leftbuttons->addArea(QRect(98, 100, 53, 30), "MAMBO/left_exit.png", act));
  ...
  addRadioWidget(ui->rightbuttons->addArea(polyArc(96, 76, 33), "MAMBO/right_ent.png", m_mouseMidClickAction));

  addRadioWidget(ui->leftbuttons->addArea(QRect(116, 165, 30, 30), "MAMBO/left_scrnshot.png", m_screenshotAction));
...
SimulatedUIWidgetMambo::~SimulatedUIWidgetMambo()
{
  delete ui;
}
