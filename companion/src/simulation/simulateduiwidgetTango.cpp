...
#include "ui_simulateduiwidgetTango.h"

// NOTE: RadioUiAction(NUMBER,...): NUMBER relates to enum EnumKeys in the specific board.h

SimulatedUIWidgetTango::SimulatedUIWidgetTango(SimulatorInterface *simulator, QWidget * parent):
  SimulatedUIWidget(simulator, parent),
  ui(new Ui::SimulatedUIWidgetTango)
{
  RadioUiAction * act;
  QPolygon polygon;
  ...
  addRadioWidget(ui->leftbuttons->addArea(QRect(78, 84, 35, 35), "TANGO/left_menu.png", act));

  act = new RadioUiAction(3, QList<int>() << Qt::Key_PageDown << Qt::Key_Down, SIMU_STR_HLP_KEYS_GO_DN, SIMU_STR_HLP_ACT_PAGE);
  addRadioWidget(ui->leftbuttons->addArea(QRect(102, 38, 35, 35), "TANGO/left_page.png", act));
  ...
  addRadioWidget(ui->leftbuttons->addArea(QRect(58, 130, 35, 35), "TANGO/left_exit.png", act));
  ...
  addRadioWidget(ui->rightbuttons->addArea(polyArc(72, 95, 40), "TANGO/right_ent.png", m_mouseMidClickAction));

  addRadioWidget(ui->leftbuttons->addArea(QRect(8, 168, 30, 30), "TANGO/left_scrnshot.png", m_screenshotAction));
...
SimulatedUIWidgetTango::~SimulatedUIWidgetTango()
{
  delete ui;
}
